...
<template>
	<Teleport to="body">
		...
		>
			<div
				v-if="modelValue"
				class="fixed inset-0 bg-zinc-900/30 backdrop-blur-md"
		...
		>
			<div
				v-if="modelValue"
				class="absolute top-24 w-full max-w-4xl inset-x-1/2 -translate-x-1/2 z-[1020] flex flex-col overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900 will-change-transform px-8 py-6 shadow-modal"
				:class="{
